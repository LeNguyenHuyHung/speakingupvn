...
{
    public class ncspeedController : BaseHomeController
    {
        ...
        public ncspeedController(IProductService productService, IBlogService blogService,
        ...
        {
            ViewBag.ReturnUrl = "ncspeed";
            var model = _blogService.GetBlogByUrlName("ncspeed");
            return View(model);
        ...
        {
            ViewBag.ReturnUrl = "/ncspeed/function";
            var model = _productService.GetProductBySlug("function-ncspeed-66");
            return View(model);
        }
    }
}