...
{
    public class DetailsBlogController : BaseHomeController
    {
        ...
        public DetailsBlogController(IProductService productService, IBlogService blogService,
        ...
        public ActionResult Index(int? page = 1)
        {
            ...
            int pageSize = 2;
            ViewBag.ReturnUrl = "DetailsBlog";
            var model = _blogService.GetBlogs().ToPagedList(pageNumber, pageSize);//lấy slug trong sql
            return View(model);
            //return View();
        }
