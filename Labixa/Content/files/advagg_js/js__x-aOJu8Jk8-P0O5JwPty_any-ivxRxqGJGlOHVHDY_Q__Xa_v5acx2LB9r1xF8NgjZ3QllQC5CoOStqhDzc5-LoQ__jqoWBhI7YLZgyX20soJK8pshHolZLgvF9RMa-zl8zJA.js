Drupal.locale = { 'strings': {"":{"Hide":"Verbergen","July":"Juli","Upgrade":"Upgrade","View more materials":"Mehr Material","View all":"Alles zeigen","No results found":"Keine Ergebnisse gefunden","Please try another category":"Versuchen Sie eine andere Kategorie","Scanned using Artec 3D technology":"Gescannt mit\u00a0Artec 3D-Technologie","Scanned using @scanner":"Gescannt mit\u00a0@scanner"}} };
;/*})'"*/
;/*})'"*/
